...
// const favorIcon = iconWhite;

// function favorSwitch() {
//     if (favorIcon === iconWhite) {
//         favorIcon = iconBlue;
//         // localStorage.setItem(THEME_KEY, selectedTheme);
//     }
//     if (favorIcon === iconBlue) {
//         favorIcon = iconWhite;
//     }
// }
//   const favBtn = document.getElementById('100000008818712');
//   console.log(favBtn);
// const galleryNews = document.querySelector('.galleryNews');
// galleryNews.addEventListener('click', (e) => {
//   if (e.target.closest('.card__favBtn')) {
//     console.log(e.target);
//     e.target.classList.add('.card__favBtn--fill');
// //const iconHeart = document.querySelector(`#btn-${ID}`);
//    // favorIcon = iconBlue;
//   }
// }); 

// export default { favorSwitch };
// export { favorIcon, favBtn };